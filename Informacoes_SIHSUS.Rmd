...
### TOTAL HOSPITALS - SUS
```{r,echo = FALSE }
  valueBox(value = "xxx",icon = "fas fa-hospital",caption = "TOTAL HOSPITALS - 100% SUS", color = rgb(1,0,0.2))
```


###  TOTAL PRIVATE HOSPITALS 
```{r,echo = FALSE }
  valueBox(value = "xxx",icon = "fas fa-hospital",caption = "TOTAL PRIVATE HOSPITALS", color = rgb(0.5,0.6,0.5))
```


### TOTAL MIXED HOSPITALS (PUBLIC AND PRIVATE)
```{r,echo = FALSE }
valueBox(value = "xxxx",icon = "fas fa-hospital",caption = "TOTAL MIXED HOSPITALS (PUBLIC AND PRIVATE)",color = rgb(0.8,0.2,0.9))
```
